...
# cp -u ${tmpdir}/battery.html index.html
# cp -u ${tmpdir}/battery.pdf .

# Update gh-pages
if git add index.html battery.pdf ${PUBLISH_ONTOLOGIES_DIR}; then
    git commit -m "Update battery documentation & ontologies"
